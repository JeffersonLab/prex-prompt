...
export DITHERING_STUB="_run_avg_eigenvectors_sorted_seg_avg_1X" # Hardcoded for now, this does the basic set of BPMs and COILs analysis
...
cd WAC/dithering
root -l -b -q "CorrectTreeEigFast.C($1,\"${DITHERING_STUB}\")"
cd -



# For just aggregation stage this is all that is needed
./any_aggregator.sh $1 configs/crex_ErrorFlag_dit_1X_runwise_eigen_seg_avg.sh
