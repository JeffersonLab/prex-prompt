...
do
    ...
    postpanConf="overload_reg.conf"
    if [ $(($run_num)) -ge 3390 ]
    then
      postpanConf="overload_reg.3390-3402.conf"
    fi
    if [ $(($run_num)) -ge 3403 ]
    then
      postpanConf="overload_reg.3403-3582.conf"
    fi
    if [ $(($run_num)) -ge 3583 ]
    then
      postpanConf="overload_reg.3583-3802.conf"
    fi
    if [ $(($run_num)) -ge 3803 ]
    then
      postpanConf="overload_reg.3803-4304.conf"
    fi
    if [ $(($run_num)) -ge 4305 ]
    then
      postpanConf="overload_reg.4305-.conf"
    fi
