...
export CAM_TYPE="ErrorFlag_dit_1X"
export CAM_CONFIG="input_CREX_respin1_mulc_bmod.txt" # The _bmod version uses the CorrectTreeFast.C outputs, not JAPAN native
export CAM_CUT="Default"
export CAM_OUTPUTDIR=/lustre19/expphy/volatile/halla/parity/crex-respin1/aggRootfiles/ErrorFlag_dit_1X
