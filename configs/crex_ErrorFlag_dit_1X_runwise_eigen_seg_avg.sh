...
export CAM_TYPE="ErrorFlag_dit_run_avg_eigenvectors_sorted_seg_avg_1X"
...
export CAM_OUTPUTDIR=/lustre19/expphy/volatile/halla/parity/crex-respin1/aggRootfiles/ErrorFlag_dit_1X_seg_avg
...
export DITHERING_STUB="_run_avg_eigenvectors_sorted_seg_avg_1X"
