...
export CAM_TYPE="Pedestals"
export CAM_CONFIG="input_Pedestals.txt" # The _bmod version uses the CorrectTreeFast.C outputs, not JAPAN native
export CAM_CUT="Pedestals"
export CAM_OUTPUTDIR=/lustre19/expphy/volatile/halla/parity/crex-respin1/aggRootfiles/Pedestals
