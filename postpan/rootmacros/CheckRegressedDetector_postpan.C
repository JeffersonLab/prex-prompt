// CheckRegressedDetector_postpan.C : 
...
void CheckRegressedDetector_postpan(){
...
//  reg_tree->AddFriend(mulc_lrb_tree);
  ...
  reg_tree->SetAlias("Aq","asym_bcm_an_ds3");
  ...
  c1->cd(1);
  reg_tree->Draw("asym_usl/ppm-Aq/ppm","ok_cut");
  c1->cd(2);
  reg_tree->Draw("asym_usr/ppm-Aq/ppm","ok_cut");
  c1->cd(3);
  reg_tree->Draw("asym_usl/ppm-Aq/ppm:asym_usr/ppm-Aq/ppm","ok_cut");
  c1->cd(4);
  reg_tree->Draw("asym_usl/ppm-asym_usr/ppm","ok_cut");
  c1->cd(5);
  reg_tree->Draw("asym_usl/ppm+asym_usr/ppm-2*Aq","ok_cut");
  c1->cd(6);
  reg_tree->Draw("asym_usl/ppm-Aq/ppm:asym_usr/ppm-Aq/ppm",
		 "ok_cut","prof");
  ...
  // Downstream
  c1->cd(1);
  reg_tree->Draw("asym_dsl/ppm-Aq/ppm","ok_cut");
  c1->cd(2);
  reg_tree->Draw("asym_dsr/ppm-Aq/ppm","ok_cut");
  c1->cd(3);
  reg_tree->Draw("asym_dsl/ppm-Aq/ppm:asym_dsr/ppm-Aq/ppm","ok_cut");
  c1->cd(4);
  reg_tree->Draw("asym_dsl/ppm-asym_dsr/ppm","ok_cut");
  c1->cd(5);
  reg_tree->Draw("asym_dsl/ppm+asym_dsr/ppm-2*Aq/ppm","ok_cut");
  c1->cd(6);
  reg_tree->Draw("asym_dsl/ppm-Aq/ppm:asym_dsr/ppm-Aq/ppm","ok_cut",
		 "prof");
  ...
  c1->cd(1);
  reg_tree->Draw("reg_asym_usl/ppm-Aq/ppm","ok_cut");
  c1->cd(2);
  reg_tree->Draw("reg_asym_usr/ppm-Aq/ppm","ok_cut");
  c1->cd(3);
  reg_tree->Draw("reg_asym_usl/ppm-Aq/ppm:reg_asym_usr/ppm-Aq/ppm","ok_cut");
  c1->cd(4);
  reg_tree->Draw("reg_asym_usl/ppm-Aq/ppm:reg_asym_usr/ppm-Aq/ppm>>hcoruslr","ok_cut",
		 "prof");
  gPad->Update();
  ...
  c1->cd(7);
  reg_tree->Draw("(reg_asym_usl/ppm+reg_asym_usr/ppm)/2-Aq/ppm","ok_cut");

  pad_buff= c1->cd(8);
  reg_tree->Draw("(reg_asym_usl/ppm+reg_asym_usr/ppm)/2-Aq/ppm:Entry$","ok_cut","COL");
  ...
  // Downstream
  c1->cd(1);
  reg_tree->Draw("reg_asym_dsl/ppm-Aq/ppm","ok_cut");
  c1->cd(2);
  reg_tree->Draw("reg_asym_dsr/ppm-Aq/ppm","ok_cut");
  c1->cd(3);
  reg_tree->Draw("reg_asym_dsl/ppm-Aq/ppm:reg_asym_dsr/ppm-Aq/ppm","ok_cut");
  c1->cd(4);
  reg_tree->Draw("reg_asym_dsl/ppm-Aq/ppm:reg_asym_dsr/ppm-Aq/ppm>>hcordslr","ok_cut",
		 "prof");
  gPad->Update();
  ...
  c1->cd(7);
  reg_tree->Draw("(reg_asym_dsl/ppm+reg_asym_dsr/ppm)/2-Aq/ppm","ok_cut");

  c1->cd(8);
  reg_tree->Draw("(reg_asym_dsl/ppm+reg_asym_dsr/ppm)/2-Aq/ppm:Entry$","ok_cut","COL");
  ...
  c0->SaveAs(output_path+filename);
  c0->Clear("D");
  gSystem->Exec(Form("convert $(ls -rt %s/*ratecheck*_postpan.png) %s/run%s_summary_regression_maindet_postpan.pdf",
		     output_path.Data(),
