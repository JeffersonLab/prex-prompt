...
export DITHERING_STUB="_run_avg_eigenvectors_sorted_part_avg_1X" # Hardcoded for now, this does the basic set of BPMs and COILs analysis
...
cd WAC/dithering
root -l -b -q "CorrectTree_EigenVectorRegression_PartAvgRegularRegression.C($1,\"${DITHERING_STUB}\")"
...
./any_aggregator.sh $1 configs/crex_ErrorFlag_dit_1X_runwise_eigen_part_avg.sh
