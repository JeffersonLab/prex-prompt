...
### CREX RESPIN scripts
## Segmentwise defined eigenvectors
#root -l -b -q bmodAna.C\($1,\"inputs/input_CREX_run_avg_1X_seg_avg_eigvec_ifarm.txt\"\);
## CREX 3 parts defined eigenvectors
root -l -b -q bmodAna.C\($1,\"inputs/input_CREX_run_avg_1X_part_avg_eigvec_ifarm.txt\"\);
