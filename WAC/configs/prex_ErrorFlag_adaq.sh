...
# Aggregator script's output destination - note you could replace "ErrorFlag" with ${CAM_TYPE} if you are feeling efficient
export CAM_OUTPUTDIR=/lustre/expphy/volatile/halla/parity/prex-respin2/aggRootfiles/ErrorFlag
