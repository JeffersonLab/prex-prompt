...
export CAM_CUT="OnlyBMOD" # "IncludeBMOD", "BMODonly" and "Burp" are alternate options
# Aggregator script's output destination - note you could replace "OnlyBMOD" with ${CAM_TYPE} if you are feeling efficient
export CAM_OUTPUTDIR=/lustre/expphy/volatile/halla/parity/prex-respin2/aggRootfiles/OnlyBMOD
