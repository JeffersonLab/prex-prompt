...
root -l -b -q CopyTree.C'("slopes_run_avg_1X_15746/dithering_slopes_15746_slug'$1'.root",'${2}')'
root -l -b -q CopyTree.C'("slopes_run_avg_4aX_15746/dithering_slopes_15746_slug'$1'.root",'${2}')'
