...
#include <string>
using namespace std;
void dithering_plot_cycles_pass1(int slugNo=0){

  char infile[300];
  sprintf(infile,"~/PREX/prompt/beam-mod/rootfiles_alldet_pass1/dit_alldet_slopes_slug%d.root",slugNo);
  ...
  for(int n=0;n<5;n++){
    int num_us4ax = tree_R->Draw(Form("%s:cyclenum",wire1[n].Data()),"","goff");
    ...
    int num_us4ex = tree_R->Draw(Form("%s:cyclenum",wire2[n].Data()),"","goff");
    ...
    int num_us4ay = tree_R->Draw(Form("%s:cyclenum",wire3[n].Data()),"","goff");
    ...
    int num_us4ey = tree_R->Draw(Form("%s:cyclenum",wire4[n].Data()),"","goff");
    ...
    int num_ds4ax = tree_R->Draw(Form("%s:cyclenum",wireavg_us[n].Data()),"","goff");
    ...
    int num_ds4ex = tree_R->Draw(Form("%s:cyclenum",wiredd_us[n].Data()),"","goff");
    ...
    int num_ds4ay = tree_R->Draw(Form("%s:cyclenum",wireavg_ds[n].Data()),"","goff");
    ...
    int num_ds4ey = tree_R->Draw(Form("%s:cyclenum",wiredd_ds[n].Data()),"","goff");
  ...
  //cds->SaveAs(Form("usr_cyclenum_slug%d_pass1.pdf",slugNo));
  cds->SaveAs(Form("plots/cyclenum_slug%d_pass1.pdf",slugNo));
  ...
  // c2->SaveAs(Form("dsl_cyclenum_slug%d_pass1.pdf",slugNo));
  c2->SaveAs(Form("plots/cyclenum_slug%d_pass1.pdf",slugNo));
  ...
  //c3->SaveAs(Form("dsr_cyclenum_slug%d_pass1.pdf",slugNo));
  c3->SaveAs(Form("plots/cyclenum_slug%d_pass1.pdf",slugNo));
  ...
  //c4->SaveAs(Form("avgus_cyclenum_slug%d_pass1.pdf",slugNo));
  c4->SaveAs(Form("plots/cyclenum_slug%d_pass1.pdf",slugNo));
  ...
  //c5->SaveAs(Form("ddus_cyclenum_slug%d_pass1.pdf",slugNo));
  c5->SaveAs(Form("plots/cyclenum_slug%d_pass1.pdf",slugNo));
  ...
  //c6->SaveAs(Form("avgds_cyclenum_slug%d_pass1.pdf",slugNo));
  c6->SaveAs(Form("plots/cyclenum_slug%d_pass1.pdf",slugNo));
