...
#include <iostream>
#include<TRandom.h>
 void invertMatrix_prex_dsr_1346(int runNo=0){
     Int_t msize=5;
     char inputfile1[300];
  ...
  ostringstream sstr0;
  sstr0<<"dsr_dithering_slope_run"<<runNo<<".txt";
...
//cyc1
    ...
    TMatrixD H_square(msize,msize);
		  ...
		  H_square[4][0] = bpm4ax_coil6[0];
                  ...
                  TMatrixD H_no(5,1);
		  H_no[0][0] = dsr_coil1[0];
		  H_no[1][0] = dsr_coil3[0];
		  H_no[2][0] = dsr_coil7[0];
		  H_no[3][0] = dsr_coil4[0];
		  H_no[4][0] = dsr_coil6[0];
...
// cyc 2 
    TMatrixD H_square2(msize,msize);
		  ...
		  H_square2[4][0] = bpm4ax_coil6[1];
                  ...
                  TMatrixD H_no2(5,1);
		  H_no2[0][0] = dsr_coil1[1];
		  H_no2[1][0] = dsr_coil3[1];
		  H_no2[2][0] = dsr_coil7[1];
		  H_no2[3][0] = dsr_coil4[1];
		  H_no2[4][0] = dsr_coil6[1];
    std::cout << "H_square" << std::endl;
    H_square2.Print();
    std::cout << "2. Use .Invert(&det)" << std::endl;
    Double_t det2_2;
...
//cyc3
    TMatrixD H_square3(msize,msize);
		  ...
		  H_square3[4][0] = bpm4ax_coil6[2];
                  ...
                  TMatrixD H_no3(5,1);
		  H_no3[0][0] = dsr_coil1[2];
		  H_no3[1][0] = dsr_coil3[2];
		  H_no3[2][0] = dsr_coil7[2];
		  H_no3[3][0] = dsr_coil4[2];
		  H_no3[4][0] = dsr_coil6[2];
    std::cout << "H_square" << std::endl;
    H_square3.Print();
    std::cout << "2. Use .Invert(&det)" << std::endl;
    Double_t det2_3;
...
//cyc4
    TMatrixD H_square4(msize,msize);
		  ...
		  H_square4[4][0] = bpm4ax_coil6[3];
                  ...
                  TMatrixD H_no4(5,1);
		  H_no4[0][0] = dsr_coil1[3];
		  H_no4[1][0] = dsr_coil3[3];
		  H_no4[2][0] = dsr_coil7[3];
		  H_no4[3][0] = dsr_coil4[3];
		  H_no4[4][0] = dsr_coil6[3];
    std::cout << "H_square" << std::endl;
    H_square4.Print();
    std::cout << "2. Use .Invert(&det)" << std::endl;
    Double_t det2_4;
...
//cyc5
    TMatrixD H_square5(msize,msize);
		  ...
		  H_square5[4][0] = bpm4ax_coil6[4];
                  ...
                  TMatrixD H_no5(5,1);
		  H_no5[0][0] = dsr_coil1[4];
		  H_no5[1][0] = dsr_coil3[4];
		  H_no5[2][0] = dsr_coil7[4];
		  H_no5[3][0] = dsr_coil4[4];
		  H_no5[4][0] = dsr_coil6[4];
    std::cout << "H_square" << std::endl;
    H_square5.Print();
    std::cout << "2. Use .Invert(&det)" << std::endl;
    Double_t det2_5;
...
//cyc6
    TMatrixD H_square6(msize,msize);
		  ...
		  H_square6[4][0] = bpm4ax_coil6[5];
                  ...
                  TMatrixD H_no6(5,1);
		  H_no6[0][0] = dsr_coil1[5];
		  H_no6[1][0] = dsr_coil3[5];
		  H_no6[2][0] = dsr_coil7[5];
		  H_no6[3][0] = dsr_coil4[5];
		  H_no6[4][0] = dsr_coil6[5];
    std::cout << "H_square" << std::endl;
    H_square6.Print();
    std::cout << "2. Use .Invert(&det)" << std::endl;
    Double_t det2_6;
   ...
   std::cout << "detector matrix" << std::endl;
    ...
    C6.Mult(H2_6,H_no6);
    C6.Print();
    outfile0<<setw(20)<<setiosflags(ios::left)<<"cyc_number"<<setw(20)<<setiosflags(ios::left)<<"dsr:4ax="<<setw(20)<<setiosflags(ios::left)<<"dsr:4ex="<<setw(20)<<setiosflags(ios::left)<<"dsr:12x="<<setw(20)<<setiosflags(ios::left)<<"dsr:4ay="<<setw(20)<<setiosflags(ios::left)<<"dsr:4ey="<<endl;
   ...
   cout<<"cyc="<<1<<"  "<<"dsr:4ax="<<C[0][0]<<"  "<<"dsr:4ex="<<C[1][0]<<"  "<<"dsr:12x="<<C[2][0]<<"  "<<"dsr:4ay="<<C[3][0]<<"  "<<"dsr:4ey="<<C[4][0]<<endl;
   cout<<"cyc="<<2<<"  "<<"dsr:4ax="<<C2[0][0]<<"  "<<"dsr:4ex="<<C2[1][0]<<"  "<<"dsr:12x="<<C2[2][0]<<"  "<<"dsr:4ay="<<C2[3][0]<<"  "<<"dsr:4ey="<<C2[4][0]<<endl;
   cout<<"cyc="<<3<<"  "<<"dsr:4ax="<<C3[0][0]<<"  "<<"dsr:4ex="<<C3[1][0]<<"  "<<"dsr:12x="<<C3[2][0]<<"  "<<"dsr:4ay="<<C3[3][0]<<"  "<<"dsr:4ey="<<C3[4][0]<<endl;
   cout<<"cyc="<<4<<"  "<<"dsr:4ax="<<C4[0][0]<<"  "<<"dsr:4ex="<<C4[1][0]<<"  "<<"dsr:12x="<<C4[2][0]<<"  "<<"dsr:4ay="<<C4[3][0]<<"  "<<"dsr:4ey="<<C4[4][0]<<endl;
   cout<<"cyc="<<5<<"  "<<"dsr:4ax="<<C5[0][0]<<"  "<<"dsr:4ex="<<C5[1][0]<<"  "<<"dsr:12x="<<C5[2][0]<<"  "<<"dsr:4ay="<<C5[3][0]<<"  "<<"dsr:4ey="<<C5[4][0]<<endl;
   cout<<"cyc="<<6<<"  "<<"dsr:4ax="<<C6[0][0]<<"  "<<"dsr:4ex="<<C6[1][0]<<"  "<<"dsr:12x="<<C6[2][0]<<"  "<<"dsr:4ay="<<C6[3][0]<<"  "<<"dsr:4ey="<<C6[4][0]<<endl;
