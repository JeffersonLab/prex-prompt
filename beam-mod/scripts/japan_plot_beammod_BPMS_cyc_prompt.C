...
int japan_plot_beammod_BPMS_cyc_prompt(TString src, int runNo=0) { 
  ...
  ostringstream sstr0;
  sstr0<<"/lustre/expphy/volatile/halla/parity/prex-respin2/ditherOutput/dit_11X12X_txt/BPMs_sensitivity_run"<<runNo<<".txt";
...
//	return 1;
   ...
   if(sens_err[0][0]==-1 || sens_err[0][1]==-1|| sens_err[0][2]==-1 || sens_err[0][3]==-1 || sens_err[0][4]==-1 || sens_err[0][5]==-1 || sens_err[0][6]==-1 || sens_err[1][0]==-1 || sens_err[1][1]==-1|| sens_err[1][2]==-1 || sens_err[1][3]==-1 || sens_err[1][4]==-1 || sens_err[1][5]==-1 || sens_err[1][6]==-1 || sens_err[2][0]==-1 || sens_err[2][1]==-1|| sens_err[2][2]==-1 || sens_err[2][3]==-1 || sens_err[2][4]==-1 || sens_err[2][5]==-1 || sens_err[2][6]==-1 || sens_err[3][0]==-1 || sens_err[3][1]==-1|| sens_err[3][2]==-1 || sens_err[3][3]==-1 || sens_err[3][4]==-1 || sens_err[3][5]==-1 || sens_err[3][6]==-1 || sens_err[4][0]==-1 || sens_err[4][1]==-1|| sens_err[4][2]==-1 || sens_err[4][3]==-1 || sens_err[4][4]==-1 || sens_err[4][5]==-1 || sens_err[4][6]==-1){
     Is_fill[i]=0;
   }else{
    Is_fill[i]=1;
   }
