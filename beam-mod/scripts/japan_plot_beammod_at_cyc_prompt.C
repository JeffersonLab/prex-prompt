...
int japan_plot_beammod_at_cyc_prompt(TString src, int runNo=0) { 
  gStyle->SetOptStat(0); 
  char infile[300];
  ...
  int coilnum=0;
    ostringstream sstr0;
  sstr0<<"/lustre/expphy/volatile/halla/parity/prex-respin2/ditherOutput/dit_11X12X_txt/AT_sensitivity_run"<<runNo<<".txt";
